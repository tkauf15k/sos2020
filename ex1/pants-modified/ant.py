...
class Ant:
    ...
    def make_move(self, dest):
        ...
        if dest is None:
            ...
            self.traveled.append(self.world.dummy_edge)
            return self.world.dummy_edge
        elif dest > -1:
            ...
            if len(self.unvisited) > 0:
                next_node_idx = random.randint(0, len(self.unvisited) - 1)
                next = self.unvisited[next_node_idx]
